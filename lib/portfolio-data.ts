...
export const profileParagraphs = [
  "Saya Mugi Nurul Ihksani, seorang backend-focused fullstack developer yang terbiasa menerjemahkan kebutuhan operasional menjadi aplikasi web yang rapi, efisien, dan siap dikembangkan.",
